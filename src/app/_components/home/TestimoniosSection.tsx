  ...
  return (
    <section className="bg-rosa py-24 px-6 relative overflow-hidden">
      ...
      <Stickers blend="soft-light" items={[
        ...
        { id: "sticker-12", top: "45%",   left: "3%", size: 70, opacity: 0.32, rotate: 0,  anim: "spin", delay: 0.6, hideOnMobile: true },
      ]} />
      <div className="max-w-7xl mx-auto relative z-10">
        <RevealOnScroll direction="up" delay={0}>
          <div className="text-center mb-16">
            <h2 className="font-display uppercase text-[clamp(2.75rem,7vw,4rem)] text-crema leading-none tracking-wide">
