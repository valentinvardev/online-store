    ...
    <section className="relative bg-crema flex flex-col overflow-hidden">
      ...
      <Stickers
        ...
        items={[
          ...
          { id: "sticker-20", top: "44%",  left: "2%",   size: 72,  opacity: 0.32, rotate: 0,   anim: "spin",      delay: 2,   hideOnMobile: true },
          { id: "sticker-21", top: "40%",  right: "2%",  size: 80,  opacity: 0.34, rotate: 14,  anim: "float",     delay: 1.2, hideOnMobile: true },
        ]}
      />
