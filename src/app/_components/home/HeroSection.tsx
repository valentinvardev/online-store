  ...
  return (
    <section className="relative bg-crema flex flex-col overflow-hidden">
      ...
      <Stickers
        blend="multiply"
        items={[
          { id: "sticker-02", top: "4%",   left: "3%",   size: 140, opacity: 0.52, rotate: -8,  anim: "float-slow" },
          { id: "sticker-17", top: "3%",   right: "4%",  size: 145, opacity: 0.5,  rotate: 12,  anim: "float",      delay: 0.8 },
          { id: "sticker-19", bottom: "4%", left: "3%",  size: 140, opacity: 0.5,  rotate: 6,   anim: "float-slow", delay: 1.6 },
