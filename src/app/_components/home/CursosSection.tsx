  ...
  return (
    <section className="bg-morado-dark py-24 px-6 relative overflow-hidden">
      <Stickers blend="screen" items={[
        { id: "sticker-04", top: "5%",   left: "3%", size: 110, opacity: 0.18, rotate: -10, anim: "float-slow" },
        { id: "sticker-11", bottom: "5%", right: "3%", size: 120, opacity: 0.2, rotate: 12, anim: "float", delay: 1.2 },
        { id: "sticker-22", top: "45%",   right: "3%", size: 72, opacity: 0.16, rotate: 0,   anim: "spin", delay: 0.6, hideOnMobile: true },
      ]} />
      <StarField />
