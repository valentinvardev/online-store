  ...
  return (
    <>
      ...
      <div className="bg-crema border-b-2 border-morado/10 py-14 px-6 relative overflow-hidden">
        {/* Stickers — en mobile solo arcoiris (sticker-16) y honguito (sticker-18) */}
        <Stickers blend="multiply" items={[
          { id: "sticker-10", top: "8%",   left: "5%",    size: 140, opacity: 0.36, rotate: -8,  anim: "float", delay: 0.8, hideOnMobile: true },
          ...
          { id: "sticker-21", bottom: "12%", left: "8%",  size: 130, opacity: 0.36, rotate: -6,  anim: "float-slow", delay: 2, hideOnMobile: true },
