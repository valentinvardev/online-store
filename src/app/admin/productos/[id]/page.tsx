  ...
  if (!producto) {
    return (
      <div className="py-24 text-center">
        <p className="font-sans text-tierra/60 text-sm">Producto no encontrado</p>
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="font-sans text-tierra/65 mt-2 tracking-wide text-sm">Modificá los datos del producto</p>
      </div>
