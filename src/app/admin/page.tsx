...
const quickLinks = [
  { label: "Nuevo curso",     href: "/admin/cursos",    color: "bg-morado-dark text-crema" },
  { label: "Nuevo producto",  href: "/admin/productos", color: "bg-dorado text-tierra-dark" },
  { label: "Ver newsletter",  href: "/admin/newsletter",color: "bg-rosa/90 text-crema" },
  { label: "Ver usuarios",    href: "/admin/usuarios",  color: "bg-verde text-crema" },
];
