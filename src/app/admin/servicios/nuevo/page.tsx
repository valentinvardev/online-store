...
const empty = {
  name: "", subtitle: "", description: "", price: "", duration: "", format: "Zoom",
};
    ...
    <div className="max-w-5xl mx-auto px-8 py-10 space-y-8">
      ...
      <div>
        ...
        <p className="font-sans text-tierra/45 mt-2 tracking-wide text-sm">
          Completá los datos para agregar una sesión o servicio
        </p>
      </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {formatos.map(({ value, label, desc }) => (
                  <button
                    ...
                    className={`py-4 px-4 border-2 text-left transition-colors ${
                      form.format === value
                        ? "bg-verde text-white border-verde"
                        : "bg-white text-tierra/50 border-morado/15 hover:border-morado/40"
                    }`}
                  >
                    <p className={`font-sans text-[0.62rem] tracking-widest uppercase font-semibold ${form.format === value ? "text-white" : "text-tierra-dark"}`}>
                      {label}
                    </p>
                    <p className={`font-sans text-[0.58rem] mt-1 ${form.format === value ? "text-white/60" : "text-tierra/30"}`}>
                      {desc}
                    </p>
                  </button>
                ))}
            ...
            <div className="bg-crema border-2 border-morado-dark block-shadow p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className={hintClass}>Ingresá solo el número, ej: 60</p>
